...
'''
    user args instance:
        map1: 
            terminal: python IEMP_Heur_Test.py -n ./test/Heuristic/map1/dataset1 -i ./test/Heuristic/map1/seed -b ./test/Heuristic/map1/seed_balanced -k 10
            PyCharm: -n ./test/Heuristic/map1/dataset1 -i ./test/Heuristic/map1/seed -b ./test/Heuristic/map1/seed_balanced -k 10
        map2:
            terminal: python IEMP_Heur_Test.py -n ./test/Heuristic/map2/dataset2 -i ./test/Heuristic/map2/seed -b ./test/Heuristic/map2/seed_balanced -k 15
            PyCharm: -n ./test/Heuristic/map2/dataset2 -i ./test/Heuristic/map2/seed -b ./test/Heuristic/map2/seed_balanced -k 15
        map3:
            terminal: python IEMP_Heur_Test.py -n ./test/Heuristic/map3/dataset3 -i ./test/Heuristic/map3/seed -b ./test/Heuristic/map3/seed_balanced -k 15
            PyCharm: -n ./test/Heuristic/map3/dataset3 -i ./test/Heuristic/map3/seed -b ./test/Heuristic/map3/seed_balanced -k 15
        map4:
            terminal: python IEMP_Heur_Test.py -n ./test/Heuristic/map4/dataset4 -i ./test/Heuristic/map4/seed -b ./test/Heuristic/map4/seed_balanced -k 2
